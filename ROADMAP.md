...
| **B2** | **Fundamentos** (en curso; detalle canónico en [`DECISIONES_PRODUCTO.md`](./docs/product/DECISIONES_PRODUCTO.md) §B2): ~~auditoría s109~~ · ~~visualId+contrato v1 pilotado s110~~ · ~~método s111~~ · ~~afinado UX s112~~ · **GIRO runner guiado (2026-07-18, enmienda R2/R3/BASE §3-A) — CERRADO 2026-07-21**: ~~s113 motor~~ (v0.57.0: reps guiadas con cadencia + transición auto de lado + rest tipado + layout por altura) · ~~s114 capa editorial~~ (v0.58.0: instrucciones por capas placeCue/shortCue/careCue + pantalla final por módulo con reps guiadas reales —resuelve el P3 antidoteDone— + Tweaks «Sesiones» descanso 20/30/45 solo betweenSets + audio sin voz move.warn/move.side) · **PRÓXIMA = B2.2b-1 contrato+duración derivada** (consolida instruction.*) · después B2.2b (b-2 feedback «¿te ayudó?» · b-3 eventos solo diseño) · B2.3 migrar el resto. **Base de conocimiento offline**: [`docs/product/BASE_MUEVE_ESTIRA.md`](./docs/product/BASE_MUEVE_ESTIRA.md) (NHS/ACSM/OMS → reglas de unidad por tipo de ejercicio, duración calculada, auditoría ejercicio-a-ejercicio ANTES de tocar código) |
