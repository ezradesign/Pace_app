...
Object.assign(window.PACE_STRINGS.es, {
    ...
    'focus.cycleComplete':             'Ciclo completado',
    'focus.manual.label':              'Foco manual',
    'focus.mode.focus':                'Foco',
    'focus.mode.pause':                'Pausa corta',
    'focus.mode.long':                 'Pausa larga',
    // Descriptor de Foco por DURACIÓN (s124). getFocusDescriptorKey (support)
    // devuelve la KEY; el consumidor traduce. Reemplaza al fijo subtitle.focus.
    'focus.subtitle.short':            'Foco breve',
    'focus.subtitle.deep':             'Concentración profunda',
    'focus.subtitle.sustained':        'Atención sostenida',
    'focus.subtitle.deepWork':         'Trabajo en profundidad',
    'focus.subtitle.extended':         'Sesión extendida',
    ...
    // CUERPO (Mueve/Estira) -> strings/sessions.body.js  (s148)
    // lib.move.* · lib.extra.* · move.* de sesión · contrato v1 · runner
    // guiado · capa editorial · el descanso que guía. Salieron de aquí al
    // rebasar este archivo las 500 líneas; su archivo lleva ES y EN juntos,
    // como manda la decisión s81.
...
Object.assign(window.PACE_STRINGS.en, {
    ...
    'focus.cycleComplete':             'Cycle complete',
    'focus.manual.label':              'Manual focus',
    'focus.mode.focus':                'Focus',
    'focus.mode.pause':                'Short break',
    'focus.mode.long':                 'Long break',
    // Focus descriptor by DURATION (s124). getFocusDescriptorKey (support)
    // returns the KEY; the consumer translates. Replaces the fixed subtitle.focus.
    'focus.subtitle.short':            'Quick focus',
    'focus.subtitle.deep':             'Deep focus',
    'focus.subtitle.sustained':        'Sustained attention',
    'focus.subtitle.deepWork':         'Deep work',
    'focus.subtitle.extended':         'Extended session',
    ...
    // BODY (Move/Stretch) -> strings/sessions.body.js  (s148)
    // Mirror of the Spanish block above: both languages travel together.
