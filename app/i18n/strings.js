...
window.PACE_STRINGS = {
  es: {
    ...
    'path.hydrate.copy':             'Un vaso de agua, si te apetece',
    'path.hydrate.drank':            'He bebido',
    'path.error.routineNotFound':    'Rutina no encontrada: {id}',
    // Caminos - nombres y taglines (sesion 51)
    'paths.path.dawn.name':           'Amanecer',
    'paths.path.dawn.tagline':        'Empieza bien el dia.',
    'paths.path.midday.name':         'Mediodia',
    'paths.path.midday.tagline':      'Recarga a mitad de jornada.',
    'paths.path.afternoon.name':      'Tarde',
    'paths.path.afternoon.tagline':   'Un segundo aire para el resto del dia.',
    'paths.path.dusk.name':           'Atardecer',
  ...
  en: {
    ...
    'path.hydrate.copy':             'A glass of water, if you feel like it',
    'path.hydrate.drank':            'I drank',
    'path.error.routineNotFound':    'Routine not found: {id}',
    // Paths - names and taglines (session 51)
    'paths.path.dawn.name':           'Dawn',
    'paths.path.dawn.tagline':        'Start the day right.',
    'paths.path.midday.name':         'Midday',
    'paths.path.midday.tagline':      'Recharge at mid-morning.',
    'paths.path.afternoon.name':      'Afternoon',
    'paths.path.afternoon.tagline':   'A second wind for the rest of the day.',
    'paths.path.dusk.name':           'Dusk',
