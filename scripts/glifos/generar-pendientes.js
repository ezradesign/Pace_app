...
L.push('---');
L.push('');
L.push('## LO QUE MÁS SE NOTÓ AL VER LAS 47 PRIMERAS (léelo antes de generar)');
L.push('');
L.push('**1 · El mueble no es decorado, es la identidad del producto.** De los 47 que');
L.push('entraron, **17 traen la postura correcta pero SIN el mueble** que el encargo');
L.push('pedía: Fondos en silla, Sentadilla a silla, Flexiones inclinadas, Hueco en silla');
L.push('y Puente torácico están dibujados en el aire o en el suelo. Funcionan, pero PACE');
L.push('es una app de oficina y sin la silla o la mesa el ejercicio pierde su contexto —');
L.push('y en algunos casos deja de distinguirse de otro parecido.');
L.push('');
L.push('> Al generar, **exige el mueble explícitamente** cuando la tabla lo mencione:');
L.push('> «con la silla justo detrás», «manos en el borde de la mesa», «espalda contra la');
L.push('> pared». Una línea recta basta; el encargo no pide más escenografía.');
L.push('');
L.push('**2 · El rojo de la zona trabajada, SUAVE y sólo sobre músculo.** La máscara');
L.push('descarta el color, así que te sirve de referencia pero no llega a la app. Si el');
L.push('rojo se solapa con el trazo del contorno, ese contorno se pierde — costó un bug');
L.push('entero en s170.');
L.push('');
L.push('**3 · El trazo, cuanto más marcado mejor.** Son grabados de línea fina y a 30 px');
L.push('hay que engordarlos artificialmente para que se lean. Un trazo de partida más');
L.push('grueso (como pide el encargo original) hace innecesario ese apaño.');
L.push('');
L.push('**4 · Encuadre: no te preocupes por centrar ni por el tamaño.** La ingesta');
L.push('recorta, centra por circunferencia mínima y normaliza todas las piezas al mismo');
L.push('tamaño óptico. Lo único que importa es que el cuerpo **entre entero**.');
L.push('');
