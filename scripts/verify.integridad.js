...
var CENSO = {
  ...
  i18nClaves: 662,   // +5 en s195c: la comida como interruptor ('ritmo.frase.sin', 'ritmo.comes', 'ritmo.nocomes', 'ritmo.aria.comes'), la tarjeta por libre ('ritmo.tarjeta.ajustar') y el atajo del modal con menú ('break.ritmo.shortcut'); sale 'break.ritmo.otra'. +9 en s195b: la pausa con menú ('break.ritmo.*', 7) y hecha/saltada ('ritmo.hecha', 'ritmo.saltada'). +2 en s195: la frase del menú SIN comida ('ritmo.frase.menu.sin', 'ritmo.frase.movil.sin'), porque «Una hora» a las 14:30 decía «comida a las 16:00». +3 en s193: la pausa abierta de «A tu ritmo» ('ritmo.empieza', 'ritmo.sidebar.ahora') y la frase de la primera vez ('ritmo.como'). +53 en s192: «A tu ritmo» (strings/ritmo.js), el dia servido -- pregunta, horario, linea, lista, aro, pausa y barra lateral. +2 en s190: la cuenta del preview ('preview.doneCount.one'/'.many'), el primer consumidor de los agregados de pace.events.v1. -10 en s188: el panel de Ajustes redisenado -- 69 claves de tweaks.*/settings.*/premium.tweaks.* salen (ninguna con consumidor, comprobado) y entran 59 bajo settings.* en strings/settings.js. +8 en s187: la propuesta del menu de pausa. +3 en s186b: el estante de Viajes de Respira. +2 en s186: la tarjeta que reanuda una sesion de Respira ('sidebar.action.resume.round' y '.meta'). +34 en s174: la biblioteca redisenada (chrome, filtros, lugar, material, grupo vacio y los ritmos de Respira). +1 en s177: 'settings.bg.music', la tercera opcion de fondo, que ya existe porque ya hay un archivo. +26 en s180: la sidebar reescrita (Hoy y sus cuatro modulos, unidades, la semana clicable, la accion continuar/repetir, el ultimo logro con sus fechas relativas, el pie y el dia en blanco)
