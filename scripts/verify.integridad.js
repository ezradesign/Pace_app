...
var CENSO = {
  ...
  i18nClaves: 582,   // +34 en s174: la biblioteca redisenada (chrome, filtros, lugar, material, grupo vacio y los ritmos de Respira). +1 en s177: 'settings.bg.music', la tercera opcion de fondo, que ya existe porque ya hay un archivo. +23 en s180: la sidebar reescrita (Hoy y sus cuatro modulos, unidades, la semana clicable, la accion continuar/repetir, el ultimo logro con sus fechas relativas, el pie y el dia en blanco)
