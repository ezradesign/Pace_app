...
| `tests/home.helpers.js` | **Utilidades compartidas de la home (s159)**: la semilla del Camino en curso, la sonda unica de geometria, el parser de px y la espera a que la home se asiente. Extraidas al partir `home-geometria.spec.js`, que habia llegado a **631 lineas** — **ni una linea de cuerpo cambio** | **NUEVO s159** |
...
- **[REDUCED-MOTION — deuda de s156, VIGILADA y sin crecer]** A 1280×720 con
  `prefers-reduced-motion: reduce` el aro sale a **420 px** en vez de 406 y la home queda con
  **11 px** de scroll. **No lo trae la atmosfera**: medido en s159 con la luz apagada y
  encendida da lo mismo, y a 390×844 son 0. Es el siguiente trabajo tecnico pequeño, despues de
  cerrar visualmente el Pomodoro.
...
> tandas, ~8 s) y la de COMPORTAMIENTO (`npm run test:e2e`, **39 tests, ~29 s**). **El CI repite
