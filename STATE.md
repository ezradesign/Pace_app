...
> s195c publica **v0.128.0, «la semana, sin decirlo»**: la pieza 3 del norte en la app, sin copy (el usuario
> eligio «nada» viendo las tres formas minimas en el panel real). Suite **282 -> 286**, banco 11 de 11.
> Diario: [session-195c](./docs/sessions/session-195c-la-semana-sin-decirlo.md).
>
