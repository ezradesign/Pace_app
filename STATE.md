...
> s195c publica **v0.127.0** (la ronda 2 decidida: la tarjeta por libre en el sitio del Camino, la comida
...
- **[LO QUE QUEDA, EN ORDEN]** La letra del usuario a `semana-copy-s195.html` y **la semana (lectura A)
  con ese copy** (v0.128.0: `ritmo.semana.js` desde el prototipo de `semana-s194.js`, la linea bajo la
  cabecera, spec y banco propios) · media jornada con horas ajustables (no se ha hecho: el usuario acepto
  «jornada = hasta la salida») · la hoja con hecha/saltada · «4 de 7 pausas» en la barra lateral y Stats ·
  la tableta vertical (sin respuesta).
